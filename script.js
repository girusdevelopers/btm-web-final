    ...
    .then((data) => {
      ...
      data.getallsongs.forEach((song) => {
        ...
        musicCard.innerHTML = `
                  ...
                  <h5 class="song-title">${song.Musictitle}</h5>
                  <p class="song-des">${song.artist}</p>
              `;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function renderArticles(articles) {
    ...
    articles.forEach((article, index) => {
      ...
      titleElement.classList.add("article-sideheading"); 
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function renderMagazines(magazines) {
    ...
    magazines.forEach((magazine, index) => {
      ...
      titleElement.classList.add("magazine-sideheading");
